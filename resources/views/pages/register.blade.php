            ...
            <div class="col-xl-12">
                <form action="#" method="post" id="register-form">
                    ...
                    <div class="row">
                        ...
                        <div class="alert alert-danger" id="msg-danger" style="display: none;">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        $("#msg-success").hide();
                        $("#msg-danger").show().text(response.message);
                    }
                },
                error: function(xhr) {
                    $(".theme-loader2").hide();
                    $("#msg-success").hide();
                    $("#msg-danger").show().text('An error occurred: ' + xhr.responseJSON.message);
                }
            });
        });
    });
