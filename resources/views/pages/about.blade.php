@include('includes.header')
				...
				<div class="col-xxl-7 col-xl-6 xl-mb-30">
					<div class="about__company-left">
						<div class="about__company-left-image dark__image">
							<img src="public/assets/img/about/about-7.jpg" alt="">
							<img src="public/assets/img/about/about-8.jpg" alt="">
						</div>
				...
				<div class="col-xxl-5 col-xl-6">
					<div class="about__company-right">
						<div class="about__company-right-title">							
							...
							<a class="btn-one" href="#">Read More<i class="far fa-chevron-double-right"></i></a>
						</div>
					</div>
				</div>
			</div>
		</div>
		<img class="about__one-shape-1" src="public/assets/img/shape/about-1.png" alt="">
		<img class="about__one-shape-2" src="public/assets/img/shape/about-2.png" alt="">
	</div>
			...
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-7 lg-mb-30">
					<div class="company__two-left">
						...
						<a class="btn-two" href="#">Discover more<i class="far fa-chevron-double-right"></i></a>
					</div>
				</div>
				<div class="col-xl-6 col-lg-5">
					<div class="company__two-right dark__image t-right">
						<img class="img__full" src="public/assets/img/about/about-9.jpg" alt="">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="about__solution" data-background="public/assets/img/about/about-solution.jpg">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-xl-8">
				...
				<div class="col-xl-4">
					<div class="about__solution-right t-right xl-t-center">						
						<a class="btn-one" href="#">Get Free Consultations<i class="far fa-chevron-double-right"></i></a>
						<img class="about__solution-right-shape left-right-animate" src="public/assets/img/shape/about-solution.png" alt="">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="company__history-area dark__image">
						<div class="company__history-area-item">
							<div class="company__history-area-item-left">
								<img src="public/assets/img/about/history-1.jpg" alt="">
							</div>
						...
						<div class="company__history-area-items">
							...
							<div class="company__history-area-items-right">
								<div class="company__history-area-items-right-image">
									<img src="public/assets/img/about/history-2.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="company__history-area-item">
							<div class="company__history-area-item-left">
								<div class="company__history-area-item-left-image">
									<img src="public/assets/img/about/history-3.jpg" alt="">
								</div>
							</div>
							<div class="company__history-area-item-right">
								<div class="company__history-area-item-right-content mb-50 xl-mb-30">
						...
						<div class="company__history-area-items">
							...
							<div class="company__history-area-items-right">
								<div class="company__history-area-items-right-image">
									<img src="public/assets/img/about/history-4.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="company__history-area-item">
							<div class="company__history-area-item-left">
								<div class="company__history-area-item-left-image">
									<img src="public/assets/img/about/history-5.jpg" alt="">
								</div>
							</div>
							<div class="company__history-area-item-right">
